...
public:
    ...
    LaneDetect(Mat startFrame)
    {
        ...
        currFrame = Mat(376,1241,CV_8UC1,0.0);                        //initialised the image size to 320x480
...
//                                    -1, 0, 1);
//        Mat dstImage;
//        filter2D(frame,dstImage,frame.depth(),kern);
//        threshold(dstImage,dstImage,50,255,THRESH_BINARY);
//
//        cv::imshow("filter2D",dstImage);
//
//        //=====================================//
...
int main()
{
    makeFromVid("../../kitti/01/left/%06d.png");
